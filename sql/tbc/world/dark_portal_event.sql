...
-- Spawn Outland Map only after event
INSERT INTO `game_event_gameobject` (`guid`, `event`) VALUES ('42457', '-100');
-- Spawn NPCs near map only after event
